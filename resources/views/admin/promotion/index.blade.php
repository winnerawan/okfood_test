                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home-icon" role="tab" aria-controls="home" aria-selected="true"><i class="la la-tags"></i> Promotions</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-icon" role="tab" aria-controls="new" aria-selected="false"><i class="la la-pencil"></i> New Promotion</a>
                                                </li>
                                            </ul>
                                                                ...
                                                                <?php $i++ ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$promotion->name}}</span>
                                                                        </td>
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$promotion->restaurant->name}}</span>
                                                                        </td>
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$promotion->description}}</span>
                                                                        </td>
                                                                        <td class="text-center">
                                                                                <div class="btn-group">
                                                                                    {!! Form::open(['route' => ['admin.promotion.edit', $promotion->id], 'method'=> 'GET']) !!}
                                                                                    <button type="submit" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit">
                                                                                        <i class="la la-pencil"></i>
                                                                                    </button>
                                                                                    {!! Form::close()  !!}
                                                                                    {!! Form::open(['route' => ['admin.promotion.destroy', $promotion->id], 'method' => 'DELETE']) !!}
