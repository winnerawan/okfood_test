                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home-icon" role="tab" aria-controls="home" aria-selected="true"><i class="la la-tags"></i> Type of Restaurant</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="new-tab" data-toggle="tab" href="#new-icon" role="tab" aria-controls="new" aria-selected="false"><i class="la la-pencil"></i> New Type</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="myTabContent">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">
                                                                                <img src="{{ ('../images/'.$type->image)}}" width="60px;" height="20px;"/>
                                                                            </span>
                                                                        </td>
                                                                        <td class="d-none d-md-table-cell">
                                                ...
                                                <div class="tab-pane fade" id="new-icon" role="tabpanel" aria-labelledby="new-tab">
                                                    <div class="col-sm-12">
                                                        {!! Form::open(['route' => 'admin.type.store', 'data-parsley-validate' => '', 'files' => true, 'method' => 'POST  ']) !!}
                                                        {{ csrf_field() }}    
