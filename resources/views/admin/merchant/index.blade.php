                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home-icon" role="tab" aria-controls="home" aria-selected="true"><i class="la la-user-secret"></i> Merchants</a>
                                                </li>
                                                {{--  <li class="nav-item">
                                                                ...
                                                                <?php $i++ ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$merchant->name}}</span>
                                                                        </td>
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$merchant->email}}</span>
                                                                        </td>
                                                                        <td class="d-none d-md-table-cell">
                                                                            <span class="text-black">{{$merchant->created_at}}</span>
                                                                        </td>
