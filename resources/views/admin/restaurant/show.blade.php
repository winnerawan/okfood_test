                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full border-b clearfix">
                            <div class="btn-group float-right">
                                <a style="margin-right: 20px" class="btn btn-info" href="{{url('/admin/restaurant')}}">
                                    <i class="fa fa-arrow-left text-primary mr-5"></i> Back to list
                                </a>
                                
                                <a style="margin-right: 20px" class="btn btn-success" href="{{ route('admin.restaurant.edit', $restaurant->id)}}">
