          ...
          <table cellpadding="0" cellspacing="0" width="600" class="wrap">
            <tr>
              <td valign="top" class="wrap-cell" style="padding-top:30px; padding-bottom:30px;">
                <table cellpadding="10" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="40" valign="top" class="header-cell">
                      <img src="{{asset('/assets/img/photos/textlogo.png')}}" alt="logo">
                    </td>
                  </tr>
                  <tr>
